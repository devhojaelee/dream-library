    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-4 md:mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-0">
          <div>
            <h1 className="text-xl md:text-3xl font-bold text-gray-900">독서 활동 대시보드</h1>
            {firstDownloadDate && (
          ...
          {/* Time Range Filter */}
          <div className="grid grid-cols-4 md:flex gap-1 md:gap-2 bg-white rounded-lg shadow-sm border border-gray-200 p-1">
            {[
              ...
              <button
                ...
                className={`px-3 md:px-4 py-2 rounded-md text-xs md:text-sm font-medium transition-colors min-h-[44px] ${
                  timeRange === value
      ...
      {downloads.length === 0 ? (
        ...
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-3 mb-4 md:mb-6">
            <div className="bg-white rounded-lg shadow-md p-3 md:p-4 border border-gray-300 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-2">
                <div className="text-[10px] md:text-xs font-semibold text-gray-700 uppercase tracking-wide">총 다운로드</div>
                <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-indigo-500 flex items-center justify-center text-lg md:text-xl shadow-sm">
                  📚
                </div>
              </div>
              <div className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight">{downloads.length}권</div>
              <div className="text-[10px] md:text-xs font-medium text-gray-600 mt-0.5">전체 기간</div>
            </div>

            <div className="bg-white rounded-lg shadow-md p-3 md:p-4 border border-gray-300 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-2">
                <div className="text-[10px] md:text-xs font-semibold text-gray-700 uppercase tracking-wide">이번 달</div>
                <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-cyan-500 flex items-center justify-center text-lg md:text-xl shadow-sm">
                  📅
                </div>
              </div>
              <div className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight">{getThisMonthCount()}권</div>
              <div className="text-[10px] md:text-xs font-medium text-gray-600 mt-0.5">
            ...
            <div className="bg-white rounded-lg shadow-md p-3 md:p-4 border border-gray-300 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-2">
                <div className="text-[10px] md:text-xs font-semibold text-gray-700 uppercase tracking-wide">월평균</div>
                <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-green-500 flex items-center justify-center text-lg md:text-xl shadow-sm">
                  📊
                </div>
              </div>
              <div className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight">{avgMonthly}권</div>
              <div className="text-[10px] md:text-xs font-medium text-gray-600 mt-0.5">권/월</div>
            </div>

            <div className="bg-white rounded-lg shadow-md p-3 md:p-4 border border-gray-300 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-2">
                <div className="text-[10px] md:text-xs font-semibold text-gray-700 uppercase tracking-wide">최다 다운로드</div>
                <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-amber-500 flex items-center justify-center text-lg md:text-xl shadow-sm">
                  🔥
                </div>
              </div>
              <div className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight">{mostActiveMonth.count}권</div>
              <div className="text-[10px] md:text-xs font-medium text-gray-600 mt-0.5">{mostActiveMonth.displayMonth || '-'}</div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-3 md:p-6 border border-gray-200 mb-4 md:mb-6">
            <div className="flex items-center justify-between mb-4 md:mb-6">
              <h3 className="text-base md:text-lg font-bold text-gray-900">독서 여정</h3>
            ...
            {/* Progress Overview */}
            <div className="bg-gray-50 rounded-lg p-3 md:p-5 mb-3 md:mb-5 border border-gray-100">
              <div className="flex items-end justify-between mb-3">
                <div>
                  <div className="text-[10px] md:text-xs font-medium text-gray-500 mb-1 uppercase tracking-wider">
                    현재 단계
                  </div>
                ...
                <div className="text-right">
                  ...
                  <div className="text-base md:text-2xl font-bold text-slate-700">
                    {downloads.length}권
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="flex items-center justify-between mt-2">
                  <span className="text-[10px] md:text-xs font-medium text-gray-600">0</span>
                  <span className="text-[10px] md:text-xs font-medium text-gray-600">{milestones.length}</span>
                </div>
              </div>
            </div>
            ...
            {nextMilestone && (
              <div className="relative bg-gradient-to-br from-slate-700 to-slate-800 rounded-lg p-3 md:p-5 mb-3 md:mb-5 overflow-hidden shadow-md">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-white bg-opacity-20 backdrop-blur-sm flex items-center justify-center text-xl md:text-2xl group-hover:scale-110 transition-transform flex-shrink-0">
                      {milestones[milestones.filter(m => m.achieved).length]?.icon}
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="text-[10px] md:text-xs font-semibold text-white opacity-80 uppercase tracking-wider mb-1">
                        다음 목표
                      </div>
                    ...
                    <div className="text-right flex-shrink-0">
                      ...
                      <div className="text-[10px] md:text-xs font-semibold text-white opacity-80">
                        권 남음
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="bg-white bg-opacity-20 rounded-full h-2 md:h-2.5 overflow-hidden">
                      <div
                        className="h-full bg-white transition-all duration-500"
                        style={{ width: `${nextMilestone.progress}%` }}
                      />
                    </div>
                    <div className="flex items-center justify-between text-white text-[10px] md:text-xs font-medium opacity-90">
                  ...
                  {nextMilestone.remaining <= 5 && (
                    <div className="mt-3 bg-yellow-400 bg-opacity-90 rounded-lg px-3 py-2">
                      <p className="text-[10px] md:text-xs font-bold text-gray-900 text-center">
                ...
                return visibleMilestones.map((milestone, idx) => {
                  ...
                  return (
                    <div
                      ...
                      className={`relative rounded-lg p-2 md:p-3 text-center transition-all duration-300 ${
                        milestone.achieved
                    ...
                    >
                      {milestone.achieved && (
                        <div className="absolute -top-1 -right-1 w-4 h-4 md:w-5 md:h-5 rounded-full bg-green-400 flex items-center justify-center shadow-md">
                      ...
                      {isNext && (
                        <div className="absolute -top-1.5 -right-1.5 bg-slate-700 text-white text-[8px] md:text-[9px] font-bold px-1 md:px-1.5 py-0.5 rounded-full shadow-sm">
                          NEXT
                        </div>
                      )}
                      <div className={`text-[9px] md:text-[10px] font-semibold mb-0.5 md:mb-1 ${
                        milestone.achieved ? 'text-white opacity-80' :
                        isNext ? 'text-amber-700' : 'text-gray-500'
                      }`}>
                        {actualIndex + 1}단계
                      </div>
                      <div className="text-xl md:text-2xl mb-0.5 md:mb-1">{milestone.icon}</div>
            ...
            {/* Stats Grid */}
            <div className="grid grid-cols-2 gap-3 md:gap-4 pt-3 md:pt-5 border-t border-gray-200">
              <div className="text-center">
                <div className="text-[10px] md:text-xs font-medium text-gray-500 mb-1 md:mb-2 uppercase tracking-wider">
                  월평균 페이스
                </div>
                <div className="text-2xl md:text-3xl font-bold text-gray-900">
                  {avgMonthly}
                </div>
                <div className="text-[10px] md:text-xs font-medium text-gray-500 mt-1">
                  권/월
                </div>
              </div>
              <div className="text-center">
            ...
            {!nextMilestone && downloads.length > 0 && (
              <div className="bg-gradient-to-br from-slate-50 to-gray-50 border-2 border-slate-200 rounded-lg p-4 md:p-6 text-center mt-3 md:mt-5">
                <div className="text-4xl md:text-5xl mb-2 md:mb-3">🏆</div>
                <div className="text-lg md:text-xl font-bold text-gray-900 mb-1 md:mb-2">
                  모든 마일스톤 달성!
                </div>
